...
import static clh.FCCLH.*;

/**
 * Created by Meepo on 1/3/2018.
 */
public class CLHDynamicGraph implements DynamicGraph {
    ...
    public void addEdge(Request r) {
        r.result = sdg.addEdge(r.u, r.v);
    }

    public void removeEdge(Request r) {
        r.result = sdg.removeEdge(r.u, r.v);
    }
