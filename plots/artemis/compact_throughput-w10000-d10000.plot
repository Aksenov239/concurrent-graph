\begin{tikzpicture}
   ...
   \nextgroupplot[title={Ratio: 50\%}, ylabel={Size: 100000}, cycle list name=color]
       \addplot table {data/comparison_throughput_100000_50_tree_FCDynamicGraph.dat};\label{plots:fc}
   ...
   \nextgroupplot[title={Ratio: 80\%}, cycle list name=color]
       \addplot table {data/comparison_throughput_100000_80_tree_FCDynamicGraph.dat};
   ...
   \nextgroupplot[title={Ratio: 100\%}, cycle list name=color]
       \addplot table {data/comparison_throughput_100000_100_tree_FCDynamicGraph.dat};
  ...
  \nextgroupplot[xlabel={Number of Threads}, ylabel={Size: 400000}, cycle list name=color]
       \addplot table {data/comparison_throughput_400000_50_tree_FCDynamicGraph.dat};
  ...
  \nextgroupplot[xlabel={Number of Threads}, cycle list name=color]
       \addplot table {data/comparison_throughput_400000_80_tree_FCDynamicGraph.dat};
       \addplot table {data/comparison_throughput_400000_80_tree_BlockingDynamicGraph.dat};

  \nextgroupplot[xlabel={Number of Threads}, cycle list name=color]
       \addplot table {data/comparison_throughput_400000_100_tree_FCDynamicGraph.dat};
